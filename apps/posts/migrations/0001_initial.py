# Generated by Django 5.2.4 on 2025-08-15 16:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(default=apps.posts.models.get_categoria_sin_categoria, null=True, on_delete=django.db.models.deletion.SET_NULL, to='posts.categoria')),
            ],
            options={
                'ordering': ('-publicado',),
            },
